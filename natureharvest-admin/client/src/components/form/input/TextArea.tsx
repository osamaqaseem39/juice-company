...
const TextArea: React.FC<TextareaProps> = ({
  ...
  if (disabled) {
    ...
    textareaClasses += ` bg-transparent text-gray-400 border-gray-300 focus:border-logo-red focus:ring focus:ring-logo-red/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:focus:border-logo-red`;
  }
